package sptas.repository;

import sptas.SptasApp;
import sptas.config.Constants;
import sptas.config.audit.AuditEventConverter;
import sptas.domain.PersistentAuditEvent;
...
import static sptas.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
